        ...
        var em={
            ...
            update: function(){
                if(this.playing){
                    ...
                    var tvol=calcPositionalVolume3d(this.position,this.radius);
                    if(tvol>0.0){
                        this.channel=audio.play(this.name,tvol*this.volume,this,this.soundDone,this.loop);
                        this.playing=true;
                    }
                }
            },
